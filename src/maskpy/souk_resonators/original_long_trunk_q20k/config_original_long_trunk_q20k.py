def get_default_resonator_config() -> dict:
    """Get the default config for the ORIGINAL_Q20k resonator.

    This is the config used in the muxing for the Q20k design. This means only
    this config is guaranteed to generate Q20k pixels reliably.
    ...
    config = {
        ...
        "meander_right_height_3": 197,  # Edited
        "meander_left_height_1": 24,
        "meander_left_height_2": 58,
        "meander_left_height_3": 180,  # Edited
        ...
        "frame_meander_cover_box_height": 150,  # Edited
        "extra_frame_meander_cover_box_width_left": 4.5,
        "extra_frame_meander_cover_box_width_right": 4.5,
        "extra_frame_meander_cover_box_height_above": 15,
        "extra_frame_meander_cover_box_height_below": 15,
